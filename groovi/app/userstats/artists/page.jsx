                        ...
                        <>
                                ...
                                <motion.div whileHover={{scale: 1.02, transition: {duration: 0.2}}}>
                                    <div key={index}
                                        ...
                                        <div className={'flex items-center text-center w-[10%]'}><a href={artist.external_urls.spotify} className={'flex items-center text-center mx-1 text-[#2fd566]'}><FaSpotify className={'w-[20px] h-auto'}/></a></div>
                                        {artist.images && artist.images.length > 0 ? (

                                            <img width={'100px'} height={'auto'} src={artist.images[0].url}
                                                 alt={'artist avatar'} className={'rounded-3xl z-30'}/>
